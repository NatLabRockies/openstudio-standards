...
4. For 179D JSONs, download `OpenStudio_Standards-ashrae_90_1(space_types).xlsx`, `OpenStudio_Standards-ashrae_90_1(space_types)_ACM2019.xlsx`, or `OpenStudio_Standards-ashrae_90_1(space_types)_ACM2019_space type.xlsx` into `data/standards`, then run `bundle exec rake data:update:179d`. This task filters schedule rows tagged with ACM/179D, remaps the 2019 ACM source rows to the 179D 90.1-2019 template, and moves generated JSONs to the corresponding 2007 directory under `lib/openstudio-standards/standards/ashrae_90_1` or the 2019 ACM directory under `lib/openstudio-standards/standards/ashrae_90_1_prm`.

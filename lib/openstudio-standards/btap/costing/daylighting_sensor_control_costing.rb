module BTAP
  class Costing
    def cost_audit_daylighting_sensor_control(model:, prototype_creator:)
      ...
      # NOTE: Number of daylighting sensors is based on how many a daylighted
      # space needs sensors as per Mike Lubun's costing spec, rather than
      # daylighting sensor control measure.
      ...
      model.getThermalZonesSorted.each do |tz|
        if tz.primaryDaylightingControl.is_initialized
          ...
          if !tz.primaryDaylightingControl.get.name().empty? &&
             tz.fractionofZoneControlledbyPrimaryDaylightingControl() > 0.00
          ...
          # Calculate tz_primary_sidelighted_area AND
          # tz_daylighted_area_under_skylights. The above
          # two area values are required for the calculation
          # of tz_primary_sidelighted_number_fixtures AND
          # tz_skylights_number_fixtures.
          daylight_spaces.sort.each do |daylight_space|
            ...
            # daylight_space based on space_type, template, and lights_type.
            search_fixture_type = {
            ...
            # COSTING-related step: Find number_fixtures_per_1000_ft2 that
            # should be considered in the daylight_space based on fixture_type
            ...
            # Costing-related step: Calculate number_fixtures_space that should
            # be considered in the daylight_space based on
            # number_fixtures_per_1000_ft2 and area of daylight_space.
            ...
            # Loop through the surfaces of each daylight_space to calculate
            # daylighted_area_under_skylights and skylight_effective_aperture
            # for each daylight_space.
          ...
          # Costing-related step: Calculate number of fixtures in thermal zones
          # with window(s).
          tz_primary_sidelighted_ratio_daylight_area = primary_sidelighted_area / tz_area
          tz_primary_sidelighted_number_fixtures = (
            tz_number_fixtures * tz_primary_sidelighted_ratio_daylight_area).ceil
          ...
          if tz_primary_sidelighted_number_sensors > 0.0
            ...
            cost_tz_primary_sidelighted_daylighting_sensor = assembly_cost(
              cost_info:  search_tz_primary_sidelighted_daylighting_sensor,
            ...
            # Cost of wiring:
            quantity_tz_primary_sidelighted_wiring = (30.0 / 100.0) * tz_primary_sidelighted_number_sensors *
              tz_multiplier
            search_tz_primary_sidelighted_wiring = { row_id_1: 'CLF', row_id_2: 10 }
            sheet_name = 'materials_lighting'
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_primary_sidelighted_wiring = assembly_cost(
              cost_info:  search_tz_primary_sidelighted_wiring,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
            ...
            search_tz_primary_sidelighted_pvc_conduit = { row_id_1: 'LF', row_id_2: 17 }
            sheet_name = 'materials_lighting'
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_primary_sidelighted_pvc_conduit = assembly_cost(
              cost_info:  search_tz_primary_sidelighted_pvc_conduit,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
            ...
            search_tz_primary_sidelighted_box = { row_id_1: 'Ea', row_id_2: 14 }
            sheet_name = 'materials_lighting'
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_primary_sidelighted_box = assembly_cost(
              cost_info:  search_tz_primary_sidelighted_box,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
          ...
          if tz_skylights_number_sensors > 0.0
            ...
            # Cost of daylighting sensor(s):
            quantity_tz_skylights_daylighting_sensor = 1.0 * tz_skylights_number_sensors * tz_multiplier
            search_tz_skylights_daylighting_sensor = { row_id_1: 'Ea', row_id_2: 407 }
            sheet_name = 'materials_lighting'
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_skylights_daylighting_sensor = assembly_cost(
              cost_info:  search_tz_skylights_daylighting_sensor,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
            ...
            search_tz_skylights_wiring = { row_id_1: 'CLF', row_id_2: 10 }
            sheet_name = 'materials_lighting'
            column_1 = 'unit'
            column_2 = 'lighting_type_id'
            cost_tz_skylights_wiring = assembly_cost(
              cost_info:  search_tz_skylights_wiring,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
            ...
            search_tz_skylights_pvc_conduit = { row_id_1: 'LF', row_id_2: 17 }
            sheet_name = 'materials_lighting'
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_skylights_pvc_conduit = assembly_cost(
              cost_info:  search_tz_skylights_pvc_conduit,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
            ...
            column_1   = 'unit'
            column_2   = 'lighting_type_id'
            cost_tz_skylights_box = assembly_cost(
              cost_info:  search_tz_skylights_box,
              sheet_name: sheet_name,
              column_1:   column_1,
              column_2:   column_2,
          ...
          @costing_report["lighting"]["daylighting_sensor_control"] << {
              ...
              'number_of_fixtures_required_without_considering_daylighted_area_under_sidelighting_and_skylights' =>
                tz_number_fixtures,
              'primary_sidelighted_area' => primary_sidelighted_area,

...
class NECB_Dimensions_Tests < Minitest::Test
  def self.runnable_methods
    %w[test_necb_slab_perimeters test_necb_dimensions]
  end
  ...
  def test_necb_slab_perimeters()
    ...
    # ---------------------- ------- ------- ---------- ---------------
    # LEEPTownHouse TOTAL    1165.37     OK     927.96      237.41
    #
    #
    # PROBLEM CASE: m2 switches between 220.14 (wrong) vs 237.41 (right)
    # ----------------------------------------------------------------------
    # LEEPTownHouse ... solution: preset 237.41 as AdditionalProperty
    #
    #
    # OTHER PROBLEM CASES (Boost feedback: "union has inner loops"):
    # ----------------------------------------------------------------------
    # LEEPMultiTower ... solution: preset 380.23 as AdditionalProperty
    # Outpatient     ... solution: preset 208.98 as AdditionalProperty
    #
    #
    ...
    # Solution is to pre-set value as AdditionalProperty in the original OSM.
    1.times do |i|
      @buildings.sort.each do |building|
        ...
        # NECBs require 1.2m of perimeter insulation for slabs (CZ4-CZ7).
        ...
        area = case building
               ...
               when "LEEPMultiTower.osm"         then 380.23
               ...
               when "Outpatient.osm"             then 208.98

...
class NECB_HVAC_System_3_Test < Minitest::Test
  ...
  def test_necb_hvac_system_3_fuel_oil2_electric_hot_water()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_3_fuel_oil2_electric_hot_water"

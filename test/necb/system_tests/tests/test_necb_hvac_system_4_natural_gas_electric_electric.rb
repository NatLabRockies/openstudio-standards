...
class NECB_HVAC_System_4_Test < Minitest::Test
  ...
  def test_necb_hvac_system_4_natural_gas_electric_electric()
    vintage = ['NECB2011']
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_4_natural_gas_electric_electric"

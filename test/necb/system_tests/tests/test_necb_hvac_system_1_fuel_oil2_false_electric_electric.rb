...
class NECB_HVAC_System_1_Test < Minitest::Test
  ...
  def test_necb_hvac_system_1_fuel_oil2_false_electric_electric()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_1_fuel_oil2_false_electric_electric"

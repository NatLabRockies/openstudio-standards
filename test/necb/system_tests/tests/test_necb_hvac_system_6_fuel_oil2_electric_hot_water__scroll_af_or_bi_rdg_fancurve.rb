...
class NECB_HVAC_System_6_Test < Minitest::Test
  ...
  def test_necb_hvac_system_6_fuel_oil2_electric_hot_water__scroll_af_or_bi_rdg_fancurve()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_fuel_oil2_electric_hot_water__scroll_af_or_bi_rdg_fancurve"
    name = 'test_necb_hvac_system_6_fuel_oil2_electric_hot_water__scroll_af_or_bi_rdg_fancurve""'

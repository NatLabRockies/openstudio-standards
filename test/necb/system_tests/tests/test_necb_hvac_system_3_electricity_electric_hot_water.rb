...
class NECB_HVAC_System_3_Test < Minitest::Test
  ...
  def test_necb_hvac_system_3_electricity_electric_hot_water()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_3_electricity_electric_hot_water"

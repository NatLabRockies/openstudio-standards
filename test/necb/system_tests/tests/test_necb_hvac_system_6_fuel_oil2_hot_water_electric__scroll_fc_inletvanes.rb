...
class NECB_HVAC_System_6_Test < Minitest::Test
  ...
  def test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_fc_inletvanes()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_fc_inletvanes"
    name = 'test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_fc_inletvanes""'

...
class TestSpaceTypeAssignment < Minitest::Test
  ...
  def test_necb2020_lpd_differs_from_necb2011
    model_2011 = BTAP::FileIO.load_osm(File.join(__dir__, '../../fixtures/geometry/simple_box.osm'))
    model_2020 = BTAP::FileIO.load_osm(File.join(__dir__, '../../fixtures/geometry/simple_box.osm'))

...
class TestHVACCoil < Minitest::Test
  ...
  def test_coil_dx_heat_pump?
    ...
    OpenstudioStandards::HVAC.model_add_hvac_system(model, 'PTHP', 'Electricity', 'Electricity', 'Electricity', model.getThermalZones)
  ...
  def test_coil_dx_heating_type
    ...
    std = Standard.build('90.1-2013')
    OpenstudioStandards::HVAC.model_add_hvac_system(model, 'PSZ-AC', 'Electricity', 'Electricity', 'Electricity', model.getThermalZones)
  ...
  def test_coil_heating_get_paired_coil_cooling_capacity
    ...
    std = Standard.build('90.1-2013')
    OpenstudioStandards::HVAC.model_add_hvac_system(model, 'PSZ-AC', 'NaturalGas', nil, 'Electricity', model.getThermalZones)

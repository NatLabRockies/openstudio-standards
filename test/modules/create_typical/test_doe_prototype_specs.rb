...
# create_custom_building_from_spec. They are generated by
# utilities/create_typical/generate_doe_prototype_specs.rb from the same space type ratios
# (get_space_types_from_building_type) and building form defaults (building_form_defaults) that
# create_bar_from_building_type_ratios uses, with standards space types converted to level-1
# typical space types. These tests check the specs are valid and that the models they produce
